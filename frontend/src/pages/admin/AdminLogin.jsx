...
export default function AdminLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Role check: Support both ADMIN and PROFESSIONAL roles
      if (user.role !== "ADMIN" && user.role !== "PROFESSIONAL") {
        setError("Access denied. Authorized accounts only.");
        return;
      }
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white/90 backdrop-blur-xl rounded-3xl p-8 border border-stone-200/80 shadow-xl">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-black text-stone-800 tracking-tight">PoseFit Portal</h1>
            <p className="text-xs text-stone-500 font-medium mt-1">Sign in to your Admin or Professional Portal</p>
          </div>
